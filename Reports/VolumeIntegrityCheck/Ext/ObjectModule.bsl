...
Procedure OnComposeResult(ResultDocument, DetailsData, StandardProcessing)
	...
	If Common.SubsystemExists("StandardSubsystems.ReportsOptions")
		...
		ModuleReportsServer.OutputHyperlink(Cell, "VolumeIntegrityCheck.RecoverFiles", NStr("en = 'Restore';tr = 'Geri yükle'"));
	EndIf;
...
Procedure FillCheckProcessing(Cancel, CheckedAttributes)
	...
	If Not ValueIsFilled(Volume) Then
		Common.MessageToUser(
			NStr("en = 'Please fill the ""Volume"" parameter.';tr = 'Birim parametresinin değeri doldurulmadı'"), , );
		Cancel = True;
		Return;
	EndIf;
