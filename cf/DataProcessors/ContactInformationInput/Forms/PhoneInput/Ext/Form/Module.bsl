...
Procedure OnCreateAtServer(Cancel, StandardProcessing)
	...
	If Common.IsMobileClient() Then
		...
		CommonClientServer.SetFormItemProperty(Items, "Presentation", "InputHint", NStr("en = 'Presentation';tr = 'Gösterim'"));
...
Function SelectionResult()
	...
	Common.CommonSettingsStorageSave("DataProcessor.ContactInformationInput.Form.PhoneInput", "CountryAndCityCodes", Codes, NStr("en = 'Codes of country and city.';tr = 'Ülke ve şehir kodu'"));
...
Procedure NotifyFillErrors(ErrorList)
	...
	If ErrorList.Count()=0 Then
		ShowMessageBox(, NStr("en = 'The phone number is valid.';tr = 'Geçerli telefon numarası girildi.'"));
		Return;
	EndIf;
