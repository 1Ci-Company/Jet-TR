...
Procedure OnCreateAtServer(Cancel, StandardProcessing)
	...
	If FileExtensionInList Then
		...
		If Not ValueIsFilled(Encoding) Then
			Encoding = NStr("en = 'Default';tr = 'Varsayılan'");
		EndIf;
	Else
...
Function ProcessWriteFileVersionCommand()
	...
	If IsBlankString(Object.Description) Then
		CommonClient.MessageToUser(
			NStr("en = 'Please specify the name of the file version.';tr = 'Devam etmek için dosya sürümün adını belirtin.'"), , "Description", "Object");
		Return False;
	EndIf;
...
Function WriteFileVersion(Val ParameterObject = Undefined)
	...
	Except
		...
		RollbackTransaction();
		WriteLogEvent(NStr("en = 'Files.Error writing version of attachment';tr = 'Dosyalar. Ekli dosya kaydedilirken bir hata oluştu.'",
