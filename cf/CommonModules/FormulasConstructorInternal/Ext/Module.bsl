		...
		If RecognizedElements[ItemDetails.Key] = Undefined Then
			If IsFunction Then
				ErrorText = StringFunctionsClientServer.SubstituteParametersToString(
					NStr("en = 'Unknown function in the expression - ""%1""';tr = 'İfadede bilinmeyen fonksiyon - ""%1""'"),
					Operand);
			Else
				ErrorText = StringFunctionsClientServer.SubstituteParametersToString(
					NStr("en = 'Field %1 is not found in the list of available fields';tr = '%1 alanı kullanılabilir alanlar listesinde bulunamadı'"),
					Operand);
			EndIf;
...
Procedure AddAListOfFieldsToTheForm(Form, Parameters) Export
	...
	SearchCleanUpButton.Title = NStr("en = 'Clear';tr = 'Temizle'");
	...
	SearchString.Title = NStr("en = 'Find';tr = 'Bul'");
	...
	FieldPicture.Title = NStr("en = 'Picture';tr = 'Resim'");
	...
	FieldPresentation.Title = NStr("en = 'Title';tr = 'Başlık'");
	...
	FieldPresentation.Title = NStr("en = 'Field';tr = 'Alan'");
...
Function ParametersForAddingAListOfFields() Export
	...
	Result.Insert("HintForEnteringTheSearchString", NStr("en = 'Find…';tr = 'Bul...'"));
	...
	For Each CollectionOfAvailableFields In CollectionsOfAvailableFields Do
		For Each FieldDetails In CollectionOfAvailableFields.Items Do
			...
			If FieldDetails.Field = New DataCompositionField("UserFields") Then
				Attribute.Title = NStr("en = 'Formulas';tr = 'Formüller'");
...
Procedure AddAGroupOfOperatorsLogicalOperatorsAndConstants(ListOfOperators)
	...
	Group.Presentation = NStr("en = 'Logical operators and constants';tr = 'Mantıksal işleçler ve sabitler'");
	Group.Order = 3;
	
	Type = New TypeDescription("Boolean");
	
	AddAnOperatorToAGroup(Group, "And", NStr("en = 'AND';tr = 'AND'"), Type);
	AddAnOperatorToAGroup(Group, "Or", NStr("en = 'OR';tr = 'OR'"), Type);
	AddAnOperatorToAGroup(Group, "Not", NStr("en = 'NOT';tr = 'NOT'"), Type);
	AddAnOperatorToAGroup(Group, "True", NStr("en = 'True';tr = 'True'"), Type);
	AddAnOperatorToAGroup(Group, "False", NStr("en = 'False';tr = 'False'"), Type);
...
Procedure AddAGroupOfOperatorsNumericFunctions(ListOfOperators)
	...
	Group.Presentation = NStr("en = 'Numeric functions';tr = 'Sayısal fonksiyonlar'");
	Group.Order = 4;
	Group.Picture = PictureLib.TypeFunction;
	
	Type = New TypeDescription("Number");
	
	AddAnOperatorToAGroup(Group, "Max", NStr("en = 'Max';tr = 'Maksimum'"), Type, True);
	AddAnOperatorToAGroup(Group, "Min", NStr("en = 'Min';tr = 'Min.'"), Type, True);
	AddAnOperatorToAGroup(Group, "Round", NStr("en = 'Round off';tr = 'Yuvarla'"), Type, True);
	AddAnOperatorToAGroup(Group, "Int", NStr("en = 'Integral part';tr = 'Tamsayı kısmı'"), Type, True);
...
Procedure AddAGroupOfOperatorsStringFunctions(ListOfOperators)
	...
	Group.Presentation = NStr("en = 'String functions';tr = 'Dize fonksiyonları'");
	Group.Order = 5;
	Group.Picture = PictureLib.TypeFunction;
	...
	AddAnOperatorToAGroup(Group, "String", NStr("en = 'Convert into a string';tr = 'Dizeye dönüştür'"), Type, True);
	AddAnOperatorToAGroup(Group, "Upper", NStr("en = 'Uppercase';tr = 'Büyük harf'"), Type, True);
	AddAnOperatorToAGroup(Group, "Lower", NStr("en = 'Lowercase';tr = 'Küçük harf'"), Type, True);
	AddAnOperatorToAGroup(Group, "Title", NStr("en = 'Each word is uppercase';tr = 'Her kelime büyük harfli'"), Type, True);
	AddAnOperatorToAGroup(Group, "Left", NStr("en = 'Left characters';tr = 'Sol karakterler'"), Type, True);
	AddAnOperatorToAGroup(Group, "Right", NStr("en = 'Right characters';tr = 'Sağ karakterler'"), Type, True);
	AddAnOperatorToAGroup(Group, "TrimL", NStr("en = 'Remove spaces on the left';tr = 'Soldaki boşlukları sil'"), Type, True);
	AddAnOperatorToAGroup(Group, "TrimAll", NStr("en = 'Remove spaces on the left and right';tr = 'Soldaki ve sağdaki boşlukları sil'"), Type, True);
	AddAnOperatorToAGroup(Group, "TrimR", NStr("en = 'Remove spaces on the right';tr = 'Sağdaki boşlukları sil'"), Type, True);
	AddAnOperatorToAGroup(Group, "StrReplace", NStr("en = 'Replace characters in the string';tr = 'Dizedeki karakterleri değiştir'"), Type, True);
	AddAnOperatorToAGroup(Group, "StrLen", NStr("en = 'String length';tr = 'Dize uzunluğu'"), New TypeDescription("Number"), True);
...
Procedure AddAGroupOfOperatorsOtherFunctions(ListOfOperators)
	...
	Group.Presentation = NStr("en = 'Other functions';tr = 'Diğer fonksiyonlar'");
	Group.Order = 6;
	Group.Picture = PictureLib.TypeFunction;
	
	AddAnOperatorToAGroup(Group, "?", NStr("en = 'Condition';tr = 'Koşul'"), New TypeDescription("Boolean"), True);
	AddAnOperatorToAGroup(Group, "ValueIsFilled", NStr("en = 'Value is filled';tr = 'Değer dolduruldu'"), New TypeDescription("Boolean"), True);
	AddAnOperatorToAGroup(Group, "Format", NStr("en = 'Format';tr = 'Format'"), New TypeDescription("String"), True);
...
Procedure AddAGroupOfOperatorsOperationsOnStrings(ListOfOperators)
	...
	Group.Presentation = NStr("en = 'String operations';tr = 'Dize işlemleri'");
	Group.Order = 2;
	
	Type = New TypeDescription("String");
	
	AddAnOperatorToAGroup(Group, "LIKE", NStr("en = 'LIKE';tr = 'LIKE'"), Type);
...
Procedure AddGroupOfOperatorsWorkingWithDates(ListOfOperators)
	...
	Group.Presentation = NStr("en = 'Date management';tr = 'Tarih işlemleri'");
	Group.Order = 2;
	Group.Picture = PictureLib.TypeFunction;
	
	Type = New TypeDescription("Number");
	
	AddAnOperatorToAGroup(Group, "YEAR", NStr("en = 'YEAR';tr = 'YEAR'"), Type, True);
	AddAnOperatorToAGroup(Group, "MONTH", NStr("en = 'MONTH';tr = 'MONTH'"), Type, True);
	AddAnOperatorToAGroup(Group, "NUMBER", NStr("en = 'NUMBER';tr = 'NUMBER'"), Type, True);
	AddAnOperatorToAGroup(Group, "DAYOFYEAR", NStr("en = 'Day of the year';tr = 'Yılın günü'"), Type, True);
	AddAnOperatorToAGroup(Group, "DAY", NStr("en = 'DAY';tr = 'DAY'"), Type, True);
	AddAnOperatorToAGroup(Group, "WEEK", NStr("en = 'WEEK';tr = 'WEEK'"), Type, True);
	AddAnOperatorToAGroup(Group, "WEEKDAY", NStr("en = 'Day of the week';tr = 'Haftanın günü'"), Type, True);
	AddAnOperatorToAGroup(Group, "HOUR", NStr("en = 'HOUR';tr = 'HOUR'"), Type, True);
	AddAnOperatorToAGroup(Group, "MINUTE", NStr("en = 'MINUTE';tr = 'MINUTE'"), Type, True);
	AddAnOperatorToAGroup(Group, "SECOND", NStr("en = 'SECOND';tr = 'SECOND'"), Type, True);

	AddAnOperatorToAGroup(Group, "BEGINOFPERIOD", NStr("en = 'Period start';tr = 'Dönem başlangıcı'"), New TypeDescription, True);
	AddAnOperatorToAGroup(Group, "ENDOFPERIOD", NStr("en = 'Period end';tr = 'Dönem sonu'"), New TypeDescription, True);
	AddAnOperatorToAGroup(Group, "ADDTODATE", NStr("en = 'Add to the date';tr = 'Tarihe ekle'"), New TypeDescription, True);
	
	AddAnOperatorToAGroup(Group, "DATEDIFF", NStr("en = 'Difference between dates';tr = 'Tarihler arasındaki fark'"), Type, True);
	
	AddAnOperatorToAGroup(Group, "CURRENTDATE", NStr("en = 'Current date';tr = 'Geçerli tarih'"), New TypeDescription, True);
...
Procedure AddAGroupOfComparisonOperationOperators(ListOfOperators)
	...
	Group.Presentation = NStr("en = 'Comparison operations';tr = 'Karşılaştırma işlemleri'");
	Group.Order = 3;
	
	Type = New TypeDescription("Boolean");
	
	AddAnOperatorToAGroup(Group, "In", NStr("en = 'IN';tr = 'IN'"), Type, True);
	AddAnOperatorToAGroup(Group, "ValueIsFilled", NStr("en = 'Value is filled';tr = 'Değer dolduruldu'"), Type, True);
...
Procedure AddAGroupOfLogicalOperationsOperators(ListOfOperators)
	...
	Group.Presentation = NStr("en = 'Logical operations';tr = 'Mantıksal işlemler'");
	Group.Order = 4;
	...
	Operator.Presentation = StringFunctionsClientServer.SubstituteParametersToString(
		...
		OperatorPresentation(NStr("en = 'CASE';tr = 'CASE'")),
		OperatorPresentation(NStr("en = 'WHEN';tr = 'WHEN'")),
		OperatorPresentation(NStr("en = 'THEN';tr = 'THEN'")));
	Operator.Picture = PictureLib.IsEmpty;
	Operator.ExpressionToInsert = StringFunctionsClientServer.SubstituteParametersToString(
		...
		OperatorPresentation(NStr("en = 'WHEN';tr = 'WHEN'")),
		OperatorPresentation(NStr("en = 'THEN';tr = 'THEN'")),
		OperatorPresentation(NStr("en = 'ELSE';tr = 'ELSE'")),
		OperatorPresentation(NStr("en = 'END';tr = 'END'")),
		NStr("en = 'Expression';tr = 'İfade'"));
	
	AddAnOperatorToAGroup(Group, "CASE", NStr("en = 'CASE';tr = 'CASE'"), , , True); // @query-part
	AddAnOperatorToAGroup(Group, "WHEN", NStr("en = 'WHEN';tr = 'WHEN'"), , , True);
	AddAnOperatorToAGroup(Group, "THEN", NStr("en = 'THEN';tr = 'THEN'"), , , True);
	AddAnOperatorToAGroup(Group, "ELSE", NStr("en = 'ELSE';tr = 'ELSE'"), , , True);
	AddAnOperatorToAGroup(Group, "END", NStr("en = 'END';tr = 'END'"), , , True);
	AddAnOperatorToAGroup(Group, "TRUE", NStr("en = 'TRUE';tr = 'TRUE'"), , , True);
	AddAnOperatorToAGroup(Group, "FALSE", NStr("en = 'FALSE';tr = 'FALSE'"), , , True);
...
Procedure AddAGroupOfOperatorsAggregateFunctions(ListOfOperators)
	...
	Group.Presentation = NStr("en = 'Aggregate functions';tr = 'Toplama fonksiyonları'");
	Group.Order = 5;
	Group.Picture = PictureLib.TypeFunction;
	
	Type = New TypeDescription("Number");
	
	AddAnOperatorToAGroup(Group, "SUM", NStr("en = 'SUM';tr = 'SUM'"), Type, True);
	AddAnOperatorToAGroup(Group, "COUNT", NStr("en = 'COUNT';tr = 'COUNT'"), Type, True);
	AddAnOperatorToAGroup(Group, "MAXIMUM", NStr("en = 'MAX';tr = 'MAX'"), Type, True);
	AddAnOperatorToAGroup(Group, "MINIMUM", NStr("en = 'MIN';tr = 'MIN'"), Type, True);
	AddAnOperatorToAGroup(Group, "MEAN", NStr("en = 'AVG';tr = 'AVG'"), Type, True);
...
Procedure AddGroupOfOperatorsOtherDCSFunctions(ListOfOperators)
	...
	AddAnOperatorToAGroup(Group, "STRING", NStr("en = 'STRING';tr = 'STRING'"), New TypeDescription("String"), True);
	AddAnOperatorToAGroup(Group, "VALUE", NStr("en = 'VALUE';tr = 'VALUE'"), New TypeDescription, True);
