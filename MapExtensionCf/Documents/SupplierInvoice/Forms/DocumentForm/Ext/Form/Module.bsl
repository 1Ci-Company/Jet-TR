...
Procedure RefreshInformation(Command) 
	...
	If NOT TrimAll(ThisObject.SupplierAdress)= "" AND NOT TrimAll(ThisObject.WarehouseAdress) = "" Then 
			GetOSRMRoadRoute(SupplierAdress , WarehouseAdress); 
		Else
...
EndProcedure
&AtServer
Function GetSupplierAdress() 
	
	Return ContactsManager.ObjectContactInformation(ThisObject.Object.Supplier ,Enums.ContactInformationTypes.Address,,True); 
EndFunction 
&AtServer
